...
**UPDATE 31/08/2013: Due to some changes to the Ingress Intel API this application is broken, since it depends on IITC. We're working on a solution. For more information see: [issue #518](https://github.com/jonatkins/ingress-intel-total-conversion/issues/518) **
